#!/usr/bin/env python3
"""
NULL_Netflow_V5_Entropy_Focused - [NULL ENTROPY v1]
==================================================
...
class NULL_Netflow_V5_Entropy_Focused:
...
if __name__ == "__main__":
    if len(sys.argv) < 3: print("Usage: python NULL_Netflow_V5_Entropy_Focused.py [compress|decompress|grep] <in> <out/query>"); sys.exit(1)
    codec = NULL_Netflow_V5_Entropy_Focused()
